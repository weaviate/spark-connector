...
case class WeaviateCluster(weaviateOptions: WeaviateOptions) extends SupportsWrite {
  ...
  override def newWriteBuilder(info: LogicalWriteInfo): WriteBuilder = WeaviateWriteBuilder(weaviateOptions)
